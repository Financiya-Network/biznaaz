                ...
                <div class="row">
                    <div class="col-sm-5 col-md-4">
                        <div class="profile-bx">
                            {{ Form::open(['method' => 'post', 'id' => 'uplaodprofileimg', 'enctype' => 'multipart/form-data']) }}
                            <div class="profile-img">
                                @if (isset($recordInfo->profile_image) && file_exists('public/files/users/small/' . $recordInfo->profile_image))
                                    {{ HTML::image('public/files/users/small/' . $recordInfo->profile_image, SITE_TITLE, ['id' => 'pimage1']) }}
                                @else
                                ...
                                <span class="ploader"
                                    id="ploader1">{{ HTML::image('public/img/loading.gif', SITE_TITLE) }}</span>
                            </div>
                            {{ Form::close() }}
                            {{ Form::open(['method' => 'post', 'id' => 'updatename']) }}
                            ...
                            ?>
                            @if (isset($recordInfo->first_name) && $recordInfo->first_name != '')
                                <div id="name_id" class="showall">
                                    <span class="curpointer-name-user">
                                        <h2 id="showname"> {!! $recordInfo->first_name . ' ' . $recordInfo->last_name !!} </h2>
                                ...
                                <div class=" displaynone" id="div_name_id">
                                    {{ Form::text('first_name', $recordInfo->first_name, ['class' => 'form-control required', 'placeholder' => 'First Name', 'autocomplete' => 'off', 'id' => 'first_name_id']) }}
                                    {{ Form::text('last_name', $recordInfo->last_name, ['class' => 'form-control required', 'placeholder' => 'Last Name', 'autocomplete' => 'off', 'id' => 'last_name_id']) }}
                            ...
                            {{ Form::open(['method' => 'post', 'id' => 'updatecontact']) }}

                            @if (isset($recordInfo->contact))
                                <div id="contactn" class="showall"> <span id="showcontact"> {!! $recordInfo->contact !!} </span>
                            ...
                            @endif
                            <div class="preview-btn"><a href="{{ URL::to('public-profile/' . $recordInfo->slug) }}"
                            ...
                            <div class="user-details">
                                <ul>
                                    <li><label><i class="fa fa-user" aria-hidden="true"></i>Member
                                            since</label><span>{!! $recordInfo->created_at->format('M Y') !!}</span></li>
                                ...
                                <div class=" displaynone" id="div_countryctn">
                                    ...
                                    <div class="educss">
                                        ...
                                        <div class="lan_field">
                                            {{ Form::text('zipcode', $recordInfo->zipcode, ['class' => 'form-control', 'placeholder' => 'Zipcode', 'autocomplete' => 'off', 'id' => 'zipcode_id', 'maxlength' => 10]) }}
                                        </div>
                                    </div>
                        ...
                        <div class="profile-txtbx">
                            ...
                            <div class="user-txt-bx">
                                ...
                                <div class="languages_div displaynone" id="div_languagesctn">
                                    <div class="lan_field">
                                        {{ Form::text('language_name', null, ['class' => 'form-control required', 'placeholder' => 'Add language', 'autocomplete' => 'off', 'id' => 'language_nameid']) }}
                                    </div>
                                    <div class="lan_field">
                                        <div class="market-select">
                                            <span>
                                    ...
                                    <ul class="items-list" id="addlangdiv">
                                        @if ($recordInfo->languages)
                                            @foreach (json_decode($recordInfo->languages) as $key => $lang)
                                                <li id="{!! $key !!}"><span
                                                        class="title">{!! $lang->lang_name !!}</span><span
                                                        class="sub-title">{!! $lang->lang_level !!}</span><span
                                                        class="hint--top"><a href="javascript:void();"
                                                            onclick="editLang('{!! $key !!}', '{!! $lang->lang_name !!}', '{!! $lang->lang_level !!}')"
                                                            title="Edit"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a> </span> <span
                                                        class="hint--top"><a href="javascript:void();"
                                                            onclick="deleteLang('{!! $key !!}')"
                            ...
                            <div class="user-txt-bx">
                                ...
                                <div class="text-section">
                                    <ul class="linked-acc">
                                        ...
                                        @else
                                            <li>
                                                <a href="{!! HTTP_PATH !!}/users/redirecttoacebook"
                                        ...
                                        @else
                                            <li>
                                                <a href="{!! HTTP_PATH !!}/users/redirecttogoogle"
                            ...
                            <div class="user-txt-bx">
                                ...
                                <div class="languages_div displaynone" id="div_educationctn">
                                    <div class="lan_field">
                                        <div class="market-select">
                                            <span>
                                                {{ Form::select('country_name', $countryLists, null, ['class' => 'form-control required', 'placeholder' => 'Country of college/university', 'id' => 'country_nameid']) }}</span>
                                        </div>
                                    </div>
                                    <div class="lan_field">
                                        {{ Form::text('university_name', null, ['class' => 'form-control required', 'placeholder' => 'College/university name', 'autocomplete' => 'off', 'id' => 'university_nameid']) }}
                                    </div>
                                    <div class="educss">
                                        <div class="lan_field qul_selecy">
                                            <div class="market-select">
                                        ...
                                        <div class="lan_field">
                                            {{ Form::text('stream_name', null, ['class' => 'form-control required', 'placeholder' => 'In stream', 'autocomplete' => 'off', 'id' => 'stream_nameid']) }}
                                        </div>
                                    </div>
                                    <div class="lan_field">
                                        <div class="market-select">
                                        ...
                                        @foreach (json_decode($recordInfo->educations) as $key => $edu)
                                            <li id="{!! $key !!}">
                                                <div class="edutop"><span
                                                        class="title">{!! $edu->qual_name !!}</span><span
                                                        class="sub-title">{!! $edu->stream_name !!}</span> <span
                                                        class="hint--top"><a href="javascript:void();"
                                                            onclick="editEdu('{!! $key !!}', '{!! $edu->country_name !!}', '{!! $edu->university_name !!}', '{!! $edu->qual_name !!}', '{!! $edu->stream_name !!}', '{!! $edu->year !!}')"
                                                            title="Edit"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a> </span> <span
                                                        class="hint--top"><a href="javascript:void();"
                                                            onclick="deleteEdu('{!! $key !!}')"
                                                            title="Delete"><i class="fa fa-trash-o"
                                                                aria-hidden="true"></i></a></span></div>
                                                <div class="edu_btm"><span class="title"> {!! $edu->university_name !!},
                                                        {!! $edu->country_name !!}, Pass in {!! $edu->year !!}</span>
                                                </div>
                                            </li>
                                        @endforeach
                                    @endif
                            ...
                            <div class="user-txt-bx user-txt-bx-last">
                                ...
                                <div class="languages_div displaynone" id="div_certificationctn">
                                    <div class="lan_field">
                                        {{ Form::text('certificate_name', null, ['class' => 'form-control required', 'placeholder' => 'Certificate or award', 'autocomplete' => 'off', 'id' => 'certificate_nameid']) }}
                                    </div>
                                    <div class="lan_field">
                                        {{ Form::text('certificate_from', null, ['class' => 'form-control required', 'placeholder' => 'Certified from (e.g. Adobe)', 'autocomplete' => 'off', 'id' => 'certificate_fromid']) }}
                                    </div>
                                    <div class="lan_field">
                                        <div class="market-select">
                                            <span>
                                ...
                                <div class="text-section" id="addcertdiv">
                                    @if ($recordInfo->certifications)
                                        @foreach (json_decode($recordInfo->certifications) as $key => $cert)
                                            <li id="{!! $key !!}">
                                                <div class="edutop"><span class="title">{!! $cert->certificate_name !!}</span>
                                                    <span class="hint--top"><a href="javascript:void();"
                                                            onclick="editCert('{!! $key !!}', '{!! $cert->certificate_name !!}', '{!! $cert->certificate_from !!}', '{!! $cert->year !!}')"
                                                            title="Edit"><i class="fa fa-pencil"
                                                                aria-hidden="true"></i></a> </span> <span
                                                        class="hint--top"><a href="javascript:void();"
                                                            onclick="deleteCert('{!! $key !!}')"
                                                            title="Delete"><i class="fa fa-trash-o"
                                                                aria-hidden="true"></i></a></span>
                                                </div>
                                                <div class="edu_btm"><span class="title"> {!! $cert->certificate_from !!}, Pass
                                                        in {!! $cert->year !!}</span></div>
                                            </li>
                                        @endforeach
                                    @endif
                                </div>
                                                    ...
                                                    <div class="thumbnail">
                                                        <div class="project-img">
                                                            ...
                                                            <a href="{{ URL::to('gig-details/' . $allrecord->slug) }}"
                                                                class="">{{ HTML::image($gigimgname, SITE_TITLE, ['title' => $allrecord->title]) }}</a>
                                                        </div>
                                                        <div class="caption">
                                                            <h3><a href="{{ URL::to('gig-details/' . $allrecord->slug) }}"
                                                                    class="">{{ mb_substr($allrecord->title, 0, 40) }}</a>
                                                            </h3>
                                                            <div class="pro-bottm">
                                                                <div class="pro-bottm-left"><a
                                                                        id="maraction-{{ $allrecord->id }}"
                                                                        class="maraction" href="javascript:void(0);"
                                                                        data-toggle="tooltip" data-placement="top"
                                                                        title="Gig Actions">{{ HTML::image('public/img/front/ellipsis.png', SITE_TITLE) }}</a>
                                                                </div>
                                                                <div class="pro-bottm-right">
                                                                    <a
                                                                        href="{{ URL::to('gig-details/' . $allrecord->slug) }}"><small>Starting
                                                                            at</small>{{ CURR . $allrecord->basic_price }}</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div id="offer-show-{{ $allrecord->id }}" class="show-adwanv">
                                                            <ul>
                                                                <li>
                                                                    <a href="{{ URL::to('gigs/edit/' . $allrecord->slug) }}"
                                                                ...
                                                                <li>
                                                                    <a href="{{ URL::to('gigs/delete/' . $allrecord->slug) }}"
                                                                        class=""
                                                ...
                                                <div class="thumbnail">
                                                    <div class="creat-new">
                                                        <a href="{{ URL::to('gigs/create') }}">
                                                            <i>
                                                                {{ HTML::image('public/img/front/plus.png', SITE_TITLE) }}</i>
                                                        ...
                                                        @if (isset($allrecord->User->slug))
                                                            <div class="management-table-tr">
                                                                <div class="management-table-td">
                                                                    {{ $allrecord->created_at->format('d M, Y') }}</div>
                                                                <div class="management-table-td">
                                                                    <div class="buyer-img">
                                                                        @if (isset($allrecord->User->profile_image))
                                                                            <a href="{{ URL::to('public-profile/' . $allrecord->User->slug) }}"
                                                                                class="">{{ HTML::image(PROFILE_SMALL_DISPLAY_PATH . $allrecord->User->profile_image, SITE_TITLE, ['style' => 'max-width: 60px']) }}</a>
                                                                        @else
                                                                            <a href="{{ URL::to('public-profile/' . $allrecord->User->slug) }}"
                                                                                class="">{{ HTML::image('public/img/front/user-img.png', SITE_TITLE, ['style' => 'max-width: 60px']) }}</a>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                <div
                                                                    class="management-table-td management-table-td-fixed dashlink management-gig-title">
                                                                    <a href="{{ URL::to('buyer-requests/' . $allrecord->slug) }}"
                                                                        class="">{{ $allrecord->title }}</a>
                                                                    <p>{{ str_limit($allrecord->description, $limit = 150, $end = '...') }}
                                                                    </p>
                                                                </div>
                                                                <div class="management-table-td">
                                                                    {{ CURR . number_format($allrecord->price, 2) }}</div>
                                                            </div>
                                                        @endif
                                                    @endforeach
                                                </div>
                                                    ...
                                                    <div class="management-table">
                                                        ...
                                                        @foreach ($myorders as $allrecord)
                                                            <div class="management-table-tr">
                                                                ...
                                                                <div class="management-table-td">{{ $allrecord->package }}
                                                                </div>
                                                                <div class="management-table-td">
                                                                    {{ CURR . $allrecord->revenue }}
                                                                </div>
                                                                <div class="management-table-td">
                                                                    <a href="#info{!! $allrecord->id !!}"
                                                        ...
                                                        <fieldset class="nzwh">
                                                            ...
                                                            <div class="drt">
                                                                ...
                                                                <div class="admin_pop"><span>Gig Title: </span>
                                                                    <label>{{ $allrecord->Gig->title or '' }}</label>
                                                                </div>
                                                                <div class="admin_pop"><span>Order Date: </span>
                                                                    <label>{{ $allrecord->created_at->format('d M, Y') }}</label>
                                                                </div>
                                                                ...
                                                                <div class="admin_pop"><span>Package: </span>
                                                                    <label>{{ $allrecord->package }}</label>
                                                                </div>
                                                                <div class="admin_pop"><span>Amount: </span>
                                                                    <label>{{ $allrecord->revenue }}</label>
                                                                </div>
                                                                <div class="admin_pop"><span>Status: </span>
                                                                    <label>{{ $gigOrderStatus[$allrecord->status] }}</label>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </div>
