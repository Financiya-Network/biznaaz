                ...
                <div class="col-sm-5 col-md-4">
                    <div class="profile-bx">
                        ...
                        <div class="profile-img">
                            @if(isset($recordInfo->profile_image) && file_exists(PROFILE_SMALL_UPLOAD_PATH.$recordInfo->profile_image))
                        ...
                        {{ Form::close()}}
                        {{ Form::open(array('method' => 'post', 'id' => 'updatename')) }}
                        ...
                        <div id="contactn" class="showall"> <span id="showcontact"> {!! $recordInfo->contact !!} </span> <span class="curpointer" onclick="showeditdiv('contactn');"><i class="fa fa-pencil" aria-hidden="true"></i></span></div>
                        ...
                        <div class="user-details">
                            ...
                            <div class=" displaynone" id="div_countryctn">
                                ...
                                <div class="educss">
                                    ...
                                    <div class="lan_field"> {{Form::text('zipcode', $recordInfo->zipcode, ['class'=>'form-control', 'placeholder'=>'Zipcode', 'autocomplete' => 'off', 'id'=>'zipcode_id', 'maxlength'=>10])}}</div>
                                </div>
                        ...
                        @if(!$myorders->isEmpty())
                            <div class="dashborad-tt">
                                ...
                                @endif
                                                ...
                                                <div class="management-table-td management-gig-title">@if(isset($allrecord->Gig))
                                        {{$allrecord->Gig->title}}
                                    ...
                                    <div id="info{!! $allrecord->id !!}" style="display: none;" class="frnt_div">
                                        <div class="nzwh-wrapper">
                                            <fieldset class="nzwh">
                                                ...
                                                <div class="drt">
                                                    <div class="admin_pop"><span>Buyer Name: </span>  <label> @if(isset($allrecord->Buyer))
                                {!! $allrecord->Buyer->first_name.' '.$allrecord->Buyer->last_name !!}
                                @else
                                {{'N/A'}}
                                @endif</label></div>
