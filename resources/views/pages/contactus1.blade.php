                ...
                <div class="st_pages_cnt">
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            <div class="stp_left">
                                <div class="stp_left_r company"><i class="fa fa-building-o"
                                        aria-hidden="true"></i><span>{!! $siteSettings->company_name !!}</span></div>
                                <div class="stp_left_r phone-number"><i class="fa fa-phone"
                                        aria-hidden="true"></i><span>{!! $siteSettings->contact_number !!}</span></div>
                                <div class="stp_left_r your-email"><i class="fa fa-envelope-o"
                                        aria-hidden="true"></i><span>{!! $siteSettings->contact_email !!}</span></div>
                                <div class="stp_left_r your-address"><i class="fa fa-map-marker"
                                        aria-hidden="true"></i><span>{!! nl2br($siteSettings->address) !!}</span></div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="stp_right">
                                ...
                                {{ Form::open(['method' => 'post', 'id' => 'contactform', 'class' => 'form form-signin']) }}
                                ...
                                <div class="form-group">
                                    <div class="inputt gcpaatcha">
                                        <div id="recaptchaQ" class="g-recaptcha" data-sitekey="{{ CAPTCHA_KEY }}"
