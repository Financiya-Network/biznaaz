    ...
    <title>Freelancers Layout V1 &#8211; Freeio</title>
    <meta name='robots' content='max-image-preview:large' />
    <link rel='dns-prefetch' href='//fonts.googleapis.com' />
    
    

    <link rel='stylesheet' id='wp-block-library-css' href='../public/css1/style.min.css' type='text/css'
        media='all' />
    ...
    <link rel='stylesheet' id='wc-blocks-vendors-style-css' href='../public/css1/wc-blocks-vendors-style.css'
                                ...
                                <div id="mobile-menu-container" class="menu-primary-menu-container">
                                    <ul id="menu-primary-menu" class="">
                                        ...
                                        <li id="menu-item-64" class="has-submenu menu-item-64"><a
                                                href="">Blog</a>
                                            <ul class="sub-menu">
                                                <li id="menu-item-5132" class="menu-item-5132"><a href="">Blog
                                                        &#8211; Grid</a></li>
                                                <li id="menu-item-5130" class="menu-item-5130"><a href="">Blog
                                                        &#8211;
                                                        List V1</a></li>
                                                <li id="menu-item-5131" class="menu-item-5131"><a href="">Blog
                                                        &#8211;
                                                        List V2</a></li>
                                                <li id="menu-item-5133" class="menu-item-5133"><a href="">Blog
                                                        &#8211; Detail</a></li>
                                            </ul>
                                        </li>
                                        <li id="menu-item-65" class="has-submenu menu-item-65"><a
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li id="menu-item-68" class="menu-item-68"><a
                                                        href="">Contact</a></li>
                                                <li id="menu-item-66" class="menu-item-66"><a href="">About
                                                        v1</a></li>
                                                <li id="menu-item-67" class="menu-item-67"><a href="">About
                                                        v2</a></li>
                                                <li id="menu-item-71" class="menu-item-71"><a
                                                        href="">Pricing</a></li>
                                                <li id="menu-item-70" class="menu-item-70"><a href="">Help</a>
                                                </li>
                                                <li id="menu-item-69" class="menu-item-69"><a href="">FAQ</a>
                                                </li>
                                            ...
                                            <div class="top-wrapper-menu ">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <a class="btn-account btn-register"
                                                        href="<?php echo e(URL::to('register')); ?>" title="Sign Up">
                                                        Sign Up </a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
